...
from exp.exp_rand import Exp_Main
import random
import numpy as np
...
# forecasting task and RAND config
parser.add_argument('--seq_len', type=int, default=96, help='input sequence length')
parser.add_argument('--label_len', type=int, default=48, help='start token length')
parser.add_argument('--pred_len', type=int, default=96, help='prediction sequence length')
parser.add_argument('--L_slice', type=int, default=48, help="Length of signal slice")
parser.add_argument("--m", type=int, default=100, help="the param of m")
